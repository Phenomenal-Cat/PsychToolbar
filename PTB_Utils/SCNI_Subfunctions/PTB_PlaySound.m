...
repetitions     = 1;
if nargin < 2
    wavDir          = '/projects/murphya/MacaqueFace3D/Macaque_video/OriginalWAVs/';
    wavFiles        = wildcardsearch(wavDir, '*.wav');
    wavFilename     = wavFiles{randi(numel(wavFiles))}; % BE_Coo_mov53.wav';
